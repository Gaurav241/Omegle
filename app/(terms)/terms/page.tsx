...
export const metadata:Metadata = {
    title: 'Terms of Use - Omeglee',
    description: 'Omeglee terms of use',
}
  ...
  return (
        <div className='flex flex-col gap-3 px-5 md:px-10 lg:px-16'>
            ...
            <div className='mt-4'>
                ...
                <p className='mt-2'>
                    By accessing or using Omeglee ("the Service"), you agree to be bound by these terms and conditions. If you do not agree with any part of these terms, you must not use the Service.
                </p>
            </div>
            ...
            <div className='mt-4'>
                ...
                <p className='mt-3'>
                Omeglee prioritizes user security and privacy.
...
Omeglee reserves the right to modify or discontinue services with or without notice.
                </p>
            </div>
            ...
            <div className='mt-4'>
                ...
                <p className='mt-3'>
                Omeglee is not liable for user actions and provides the Service "as-is."
<br />Users are responsible for the risks associated with online interactions.
            ...
            <p className='bg-sky-300/40 mb-8'>
                By using Omeglee, you acknowledge that you have read, understood, and agree to these terms and conditions. These terms are subject to change, and any modifications will be effective upon posting. It is your responsibility to review and stay informed of any updates.
            </p>
        </div>
    )
}
