    ...
    <Dialog open={isModalOpen} onClose={handleClose} aria-labelledby="terms-dialog-title">
      ...
      <DialogContent>
        ...
        <div className=''>
            ...
            reviewed and agree to the Omeglee <Link href="/terms" style={{textDecoration:'underline',color:'blue'}}>Terms of Service</Link>, <Link href="/privacy" style={{textDecoration:'underline',color:'blue'}}>Privacy Policy</Link>
           </p>
        </div>

        <div className='mt-2'>
           <p><input type="checkbox"style={{width: "15px", height: "15px"}} onChange={(event: React.ChangeEvent<HTMLInputElement>) => setSecondChecked(event.target.checked)}/> You must be 18+ or 13+ to use Omeglee If you are between 13 and 18 years of age, you may only
            use Omeglee with the permission and your legal guardian
            . Persions under the age of 13 <span className='font-bold'>may not</span> use Omeglee. See our <Link className='text-blue-800 underline' href="/terms" style={{textDecoration:'underline',color:'blue'}}>Terms of Service</Link> for more info. 
